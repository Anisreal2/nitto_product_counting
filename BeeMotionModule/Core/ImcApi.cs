...
namespace Inovance.InoMotionCotrollerShop.InoServiceContract.EtherCATConfigApi
{
    ...
    public class ImcApi
    {
        ...
        //_DLL_API UINT32 IMC_SetLocalEncDir(HANDLETYPE cardHandle, INT16 index, INT16 *dir, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetLocalEncDir(HANDLETYPE cardHandle, INT16 index, INT16 *dir, INT16 count = 1);
        ...
        public static extern UInt32 IMC_SetLocalEncDir(HANDLETYPE cardHandle, Int16 index, Int16[] dir, Int16 count = 1);
        ...
        public static extern UInt32 IMC_GetLocalEncDir(HANDLETYPE cardHandle, Int16 index, Int16[] dir, Int16 count = 1);
        ...
        //_DLL_API UINT32 IMC_WriteUserCode(HANDLETYPE cardHandle, char *pCode, INT16 len);
        //_DLL_API UINT32 IMC_CheckUserCode(HANDLETYPE cardHandle, char *pCode, INT16 len);
        ...
        public static extern UInt32 IMC_WriteUserCode(HANDLETYPE cardHandle, string pCode, Int16 len);
        ...
        public static extern UInt32 IMC_CheckUserCode(HANDLETYPE cardHandle, string pCode, Int16 len);
        ...
        ////_DLL_API UINT32 IMC_SetAxEquiv(HANDLETYPE cardHandle, INT16 axNo, double *pAxEqu,INT16 count=1);
        ////_DLL_API UINT32 IMC_GetAxEquiv(HANDLETYPE cardHandle, INT16 axNo, double *pAxEqu,INT16 count=1);
        ...
        public static extern UInt32 IMC_SetAxEquiv(HANDLETYPE cardHandle, Int16 axNo, double[] pAxEqu, Int16 count = 1);
        ...
        public static extern UInt32 IMC_GetAxEquiv(HANDLETYPE cardHandle, Int16 axNo, double[] pAxEqu, Int16 count = 1);
        ...
        ///*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
        //_DLL_API UINT32 IMC_GetSlaveCurSts(HANDLETYPE cardHandle, UINT16 Station_id, UINT16 cnt, INT16 *pStatus);
        //_DLL_API UINT32 IMC_GetSlaveReqSts(HANDLETYPE cardHandle, UINT16 Station_id, UINT16 cnt, INT16 *pStatus);
        ...
        ///*----2.2.2 编码器操作接口                                               ---*/
        ///*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
        //_DLL_API UINT32 IMC_GetLocalCntPos(HANDLETYPE cardHandle, INT16 index, INT32 *pCntPos, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetLocalCntVel (HANDLETYPE cardHandle, INT16 index,INT32 *pCntVel,INT16 count = 1);
        //_DLL_API UINT32 IMC_GetLocalEncPos(HANDLETYPE cardHandle,INT16 index,INT32 *pEncPos,INT16 count = 1);
        //_DLL_API UINT32 IMC_GetLocalEncVel (HANDLETYPE cardHandle, INT16 index,INT32 *pEncVel,INT16 count = 1);
        ...
        ///*----2.2.4 位置比较输出操作接口                                            ---*/
        ///*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
        //_DLL_API UINT32 IMC_CompareSrcConfig(HANDLETYPE cardHandle, INT16 portNo, INT16 dimension, INT16 *pCompSrc, INT16 *pCmpType);
        ...
        //_DLL_API UINT32 IMC_SetCompareData(HANDLETYPE cardHandle, INT16 portNo, INT16 compCount, INT32 *pPosBuf);
        ...
        //_DLL_API UINT32 IMC_SetMultiDimensCompareData(UINT64 cardHandle,INT16 portNo,TMultiCmpData *pComparaData,INT16 count);
        ...
        //public static extern UInt32 IMC_StartHoming(HANDLETYPE cardHandle, Int16 axNo);
        [DllImport(EtherCATConfigApiDllName, EntryPoint = "IMC_StartHoming", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
        ...
        ///*----4.2 轴状态管理接口                                                 ---*/
        ///*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
        //_DLL_API UINT32 IMC_GetAxPrfMode(HANDLETYPE cardHandle, INT16 axNo, INT16 *pPrfMode, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetAxSts(HANDLETYPE cardHandle, INT16 axNo, INT32 *pAxSts, INT16 count = 1);
        //_DLL_API UINT32 IMC_ClrAxSts(HANDLETYPE cardHandle, INT16 axNo, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetAxPrfPos(HANDLETYPE cardHandle, INT16 axNo, double *pPrfPos, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetAxPrfVel(HANDLETYPE cardHandle, INT16 axNo, double *pPrfVel, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetAxPrfAcc(HANDLETYPE cardHandle, INT16 axNo, double *pPrfAcc, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetAxEncPos(HANDLETYPE cardHandle, INT16 axNo, double *pEncPos, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetAxEncVel(HANDLETYPE cardHandle, INT16 axNo, double *pEncVel, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetAxEncAcc(HANDLETYPE cardHandle, INT16 axNo, double *pEncAcc, INT16 count = 1);
        //_DLL_API UINT32 IMC_GetPrfPos(HANDLETYPE cardHandle, INT16 axNo, double *pPrfPos, INT16 count = 1);
        ...
        ////_DLL_API UINT32 IMC_ConfigSampleData(HANDLETYPE cardHandle, INT16 count, INT16 *pDataType, INT16 *pDataIndex);
        ...
        ////_DLL_API UINT32 IMC_GetSampleData(HANDLETYPE cardHandle, INT16 *pPackNum, INT16 *pData);
        ...
        //_DLL_API  UINT32 IMC_StartMultiPtpMove(UINT64 cardHandle, INT16 axNum, INT16 *pAxNo, double *pTgtPos, INT16 *pPosType);
        ...
        /*----7.4 直角坐标系插补运动模式接口                                     ---*/
        /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
        //_DLL_API UINT32 IMC_CrdSetMtSys(UINT64 cardHandle, INT16 crdNo,INT16 *pMaskAxNo,INT16 lookAheadLen,double estopDec);
        //_DLL_API UINT32 IMC_CrdGetMtSysParam(UINT64 cardHandle, INT16 crdNo,INT16 *pMaskAxNo,INT16 *pLookAheadLen,double *pEstopDec);
        ...
        public static extern UInt32 IMC_CrdArcThreePoint(HANDLETYPE cardHandle, Int16 crdNo, double[] pMidPos, double[] pEndPos, Int32 userID);
        ...
        public static extern UInt32 IMC_CrdSpiralAngleXYPlane(HANDLETYPE cardHandle, Int16 crdNo, double[] pCenter, double angle, double height, double m, Int32 userID);
        ...
        public static extern UInt32 IMC_CrdSpiralAngleYZPlane(HANDLETYPE cardHandle, Int16 crdNo, double[] pCenter, double angle, double height, double m, Int32 userID);
        ...
        public static extern UInt32 IMC_CrdSpiralAngleZXPlane(HANDLETYPE cardHandle, Int16 crdNo, double[] pCenter, double angle, double height, double m, Int32 userID);
        ...
        public static extern UInt32 IMC_CrdEllipseFullXYPlane(HANDLETYPE cardHandle, Int16 crdNo, double[] pCenter, double b, Int16 dir, Int32 userID);
        ...
        public static extern UInt32 IMC_CrdEllipseFullYZPlane(HANDLETYPE cardHandle, Int16 crdNo, double[] pCenter, double b, Int16 dir, Int32 userID);
        ...
        public static extern UInt32 IMC_CrdEllipseFullZXPlane(HANDLETYPE cardHandle, Int16 crdNo, double[] pCenter, double b, Int16 dir, Int32 userID);
        ...
        public static extern UInt32 IMC_MutiSyncMotion(HANDLETYPE cardHandle, Int16 groupNo, double[] pEndPos, short[] pVelRatio, short[] pAccRatio, double blendRatio, Int32 userID);
        ...
        public static extern UInt32 IMC_MutiSyncMotionInRatio(HANDLETYPE cardHandle, Int16 groupNo, double[] pEndPos, short[] pVelRatio, short[] pAccRatio, double blendRatio, Int32 userID);
        ...
        public static extern UInt32 IMC_MutiSyncMotionLookaheadInRatio(HANDLETYPE cardHandle, Int16 groupNo, double[] pEndPos, short[] pVelRatio, short[] pAccRatio, double cornerRatio, Int32 userID);
        ...
        public static extern UInt32 IMC_MutiSyncMotionInAxVelAcc(HANDLETYPE cardHandle, Int16 groupNo, double[] pEndPos, double[] pTrajVel, double[] pTrajAcc, double[] pTrajdec, double blendRatio, Int32 userID);
        ...
        public static extern UInt32 IMC_MutiSyncMotionLookaheadInAxVelAcc(HANDLETYPE cardHandle, Int16 groupNo, double[] pEndPos, double[] pTrajVel, double[] pTrajAcc, double[] pTrajdec, double cornerRatio, Int32 userID);
        ...
        public static extern UInt32 IMC_MutiSyncMotionInAccDecTime(HANDLETYPE cardHandle, Int16 groupNo, double[] pEndPos, double[] pTrajVel, double accTime, double decTime, double blendRatio, Int32 userID);
        ...
        public static extern UInt32 IMC_MutiSyncMotionInRunTime(HANDLETYPE cardHandle, Int16 groupNo, double[] pEndPos, double runTime, double accTime, double decTime, double blendRatio, Int32 userID);
        ...
        public static extern UInt32 IMC_MutiSyncMotionLookaheadInSynVelAcc(HANDLETYPE cardHandle, Int16 groupNo, double[] pEndPos, double trajVel, double trajAcc, double trajdec, double cornerRatio, Int32 userID);
        ...
        public static extern UInt32 IMC_MutiSyncMotionInSynVelAcc(HANDLETYPE cardHandle, Int16 groupNo, double[] pEndPos, double trajVel, double trajAcc, double trajdec, double blendRatio, Int32 userID);
        ...
        public static extern UInt32 IMC_SetupPtPackSys(HANDLETYPE cardHandle, Int16 sysNo, ref Int16 pMaskAxNo, Int16 maxAxNum);
        ...
        public static extern UInt32 IMC_AddMotionPointPtPack(HANDLETYPE cardHandle, Int16 sysNo, ref Int32 pPos, ref Int16 pType, double T, Int16 dataNum);
        ...
        public static extern UInt32 IMC_EnablePtPackNoDataProtect(HANDLETYPE cardHandle, Int16 sysNo, ref double pThresholdVel);
        ...
        public static extern UInt32 IMC_GetPtPackNoDataProtectStatus(HANDLETYPE cardHandle, Int16 sysNo, ref Int16 pEnSts, ref double pThresholdVel);
